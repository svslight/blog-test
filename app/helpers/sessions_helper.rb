module SessionsHelper
  ...
  # Перенаправляет (дружелюбно) к сохраненному расположению (или по умолчанию).
  # Добавим этот метод в действие create контроллера Sessions для переадресации после успешного входа
  ...
  # Добавить store_location в users_controller - предфильтр logged_in_user
  def store_location
